...
public class RemoveSavedChannelOperationTest
{

    @GeneratePojo
    private RemoveSavedChannelRequest request;

    private RemoveSavedChannelOperation instance;

    @Before
    public void setUp()
    {
        instance = new RemoveSavedChannelOperation();
    }

    @Test
    public void testProcess() throws Exception
    {
        RemoveSavedChannelResponse response = instance.process(request);
