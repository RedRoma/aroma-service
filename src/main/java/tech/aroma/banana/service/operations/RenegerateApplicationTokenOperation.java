 ...
 */
final class RenegerateApplicationTokenOperation implements ThriftOperation<RegenerateApplicationTokenRequest, RegenerateApplicationTokenResponse>
{

    private final static Logger LOG = LoggerFactory.getLogger(RenegerateApplicationTokenOperation.class);
